...
# Generated 2024-03-18 15:32:15.461528 by PyXB version 1.2.6 using Python 3.10.12.final.0
...
class FormationIDType (pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/root/python/stomp-client-python/ppv16/rttiPPTCommonTypes_v3.xsd', 13, 1)
...
class LoadingValue (pyxb.binding.datatypes.unsignedInt):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/root/python/stomp-client-python/ppv16/rttiPPTCommonTypes_v3.xsd', 22, 1)
...
class CoachNumberType (pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/root/python/stomp-client-python/ppv16/rttiPPTCommonTypes_v3.xsd', 30, 1)
...
class CoachClassType (pyxb.binding.datatypes.string):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/root/python/stomp-client-python/ppv16/rttiPPTCommonTypes_v3.xsd', 39, 1)
